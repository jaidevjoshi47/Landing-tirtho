...
export const LandingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FDFBF7] text-[#0F172A] font-['Plus_Jakarta_Sans',sans-serif] selection:bg-[#F97316] selection:text-white">
      ...
      {/* 1. Header Navigation Bar (Restored Original Nav Links) */}
      <nav className="sticky top-0 z-50 bg-white/90 backdrop-blur-md border-b border-orange-100/80 px-4 lg:px-10 py-3 shadow-[0_2px_15px_rgba(249,115,22,0.05)]">
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
          ...
          {/* Restored Original Navigation Links */}
          <div className="hidden md:flex items-center gap-7 text-xs font-bold text-slate-700">
            ...
            <a href="#places" className="hover:text-[#F97316] transition-colors">Tourist Spots</a>
            <a href="#planner" className="hover:text-[#F97316] transition-colors">AI Trip Planner</a>
            <a href="#download" className="hover:text-[#F97316] transition-colors">Download APK</a>
          </div>
      ...
      {/* 2. Hero Section */}
      <section id="home" className="relative overflow-hidden pt-10 pb-16 px-4 lg:px-10 bg-gradient-to-b from-[#FFF9F2] via-[#FDFBF7] to-[#FDFBF7]">
      ...
      <section id="features" className="py-16 px-4 lg:px-10 bg-white">
        <div className="max-w-7xl mx-auto space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {/* Feature 1 */}
            <div className="p-6 bg-[#FDFBF7] border border-orange-100/80 rounded-3xl space-y-4 hover:shadow-lg transition-all">
              <div className="w-12 h-12 rounded-2xl bg-orange-100 text-[#F97316] flex items-center justify-center">
                <Bot className="w-6 h-6" />
              </div>
              <h3 className="text-xl font-['Playfair_Display',serif] font-black text-slate-900">Bhaskar AI Voice Assistant</h3>
            ...
            <div className="p-6 bg-[#FDFBF7] border border-orange-100/80 rounded-3xl space-y-4 hover:shadow-lg transition-all">
              ...
              <h3 className="text-xl font-['Playfair_Display',serif] font-black text-slate-900">Live Crowd & Queue Wait Time</h3>
              <p className="text-xs text-slate-600 leading-relaxed font-medium">
            ...
            <div className="p-6 bg-[#FDFBF7] border border-orange-100/80 rounded-3xl space-y-4 hover:shadow-lg transition-all">
              ...
              <h3 className="text-xl font-['Playfair_Display',serif] font-black text-slate-900">1-Tap & Custom Yatra Planner</h3>
              <p className="text-xs text-slate-600 leading-relaxed font-medium">
            ...
            <div className="p-6 bg-[#FDFBF7] border border-orange-100/80 rounded-3xl space-y-4 hover:shadow-lg transition-all">
              ...
              <h3 className="text-xl font-['Playfair_Display',serif] font-black text-slate-900">Live Map Navigation</h3>
              <p className="text-xs text-slate-600 leading-relaxed font-medium">
            ...
            <div className="p-6 bg-[#FDFBF7] border border-orange-100/80 rounded-3xl space-y-4 hover:shadow-lg transition-all">
              ...
              <h3 className="text-xl font-['Playfair_Display',serif] font-black text-slate-900">Prasadalaya & Satvik Food Finder</h3>
              <p className="text-xs text-slate-600 leading-relaxed font-medium">
            ...
            {/* Feature 6 */}
            <div className="p-6 bg-[#FDFBF7] border border-orange-100/80 rounded-3xl space-y-4 hover:shadow-lg transition-all">
              <div className="w-12 h-12 rounded-2xl bg-[#FFE0C2] text-[#F97316] flex items-center justify-center">
                <ShieldCheck className="w-6 h-6" />
              </div>
              <h3 className="text-xl font-['Playfair_Display',serif] font-black text-slate-900">100% Independent & Free</h3>
              <p className="text-xs text-slate-600 leading-relaxed font-medium">
      ...
      <section id="planner" className="py-14 px-4 lg:px-10 bg-white">
